...
/** Last conversation opened by the user; used to restore the Android app session. */
export const LAST_ACTIVE_CONVERSATION_LOCALSTORAGE_KEY = `${STORAGE_APP_NAME}.lastActiveConversation`;
