...
ggml_tensor * llama_model_deepseek4::graph::build_csa_lid_attention(
    ...
    ggml_tensor * out = build_attn_mha(q, k_all, k_all, nullptr, kq_mask, nullptr, sinks, nullptr, kq_scale, il);
    if (k_rot) {
...
ggml_tensor * llama_model_deepseek4::graph::build_raw_attention(
    ...
    ggml_tensor * out = build_attn_mha(q, k, k, nullptr, kq_mask, nullptr, sinks, nullptr, kq_scale, il);
    if (k_rot) {
        out = llama_mul_mat_hadamard(ctx0, out, k_rot);
    }
    cb(out, "attn_raw", il);
